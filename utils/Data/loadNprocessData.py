...
from utils.Data.data_distribution import graph_user_distribution, graph_action_distribution

def readRAWData():
    from utils.Data.data_distribution import graph_user_distribution, graph_action_distribution

    # path = './Dataset/WISDM_ar_v1.1/WISDM_ar_v1.1_raw.csv'
    path = 'utils/Data/Dataset/WISDM_ar_v1.1/WISDM_ar_v1.1_raw.csv'
    file = open(path)
    ...
    graph_user_distribution(processedList)
    graph_action_distribution(processedList)
...
def preprocessData(data):
    ...
    # saving data
    path = 'utils/Data/Dataset/WISDM_ar_v1.1/ScaledData.csv'
